...
"""
The main file for the Espdrone control application.
"""
import logging
import sys

import edclient
import edclient.ui.tabs
import edclient.ui.toolboxes
import edlib.crtp
from edclient.ui.dialogs.about import AboutDialog
from edclient.ui.dialogs.bootloader import BootloaderDialog
from edclient.utils.config import Config
from edclient.utils.config_manager import ConfigManager
from edclient.utils.input import JoystickReader
from edclient.utils.logconfigreader import LogConfigReader
from edclient.utils.zmq_led_driver import ZMQLEDDriver
from edclient.utils.zmq_param import ZMQParamAccess
...
class ScannerThread(QThread):
    ...
    def scan(self, address):
        self.interfaceFoundSignal.emit(edlib.crtp.scan_interfaces(address))
